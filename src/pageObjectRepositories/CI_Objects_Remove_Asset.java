...
public class CI_Objects_Remove_Asset {
    ...
    public static WebElement cbx_meter_to_remove(WebDriver driver) {
    	...
    	try {
    		element = driver.findElement(By.id("selectMeterRemoveRACI"));
    	}catch(Exception e) {
    ...
    public static WebElement btn_add_removed_meter(WebDriver driver) {
    	...
    	try {
    		element = driver.findElement(By.id("btnAddRemoveRACI"));
    	}catch(Exception e) {
    ...
    public static WebElement cbx_removed_asset_status(WebDriver driver) {
    	...
    	try {
    		element = driver.findElement(By.id("selectRemoveAssetRAC-0"));
    	}catch(Exception e) {
    ...
    public static WebElement btn_confirm_asset_removed_y(WebDriver driver) {
    	...
    	try {
    		element = driver.findElement(By.id("radiotargetfieldTrueRACI-0"));
    	}catch(Exception e) {
    ...
    public static WebElement btn_confirm_asset_removed_n(WebDriver driver) {
    	...
    	try {
    		element = driver.findElement(By.id("radiotargetfieldFalseRACI-0"));
    	}catch(Exception e) {
    ...
    */
    ...
    public static WebElement btn_next_section(WebDriver driver) {
    	...
    	try {
    		element = driver.findElement(By.id("btnNextRACI"));
    	}catch(Exception e) {
