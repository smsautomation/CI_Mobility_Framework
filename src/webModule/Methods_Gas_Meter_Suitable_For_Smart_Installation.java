...
public class Methods_Gas_Meter_Suitable_For_Smart_Installation{
	...
	* Author: Iain Storrie
	* Date: 20/06/2017
	* Purpose: This method checks the main page elements on the Gas Meter Suitable For Smart 
...
/*
	public static void viewPage(WebDriver driver, String sTestCaseName) throws Exception{
		...
		Objects_Gas_Meter_Suitable_For_Smart_Installation_Page.btn_Suitable_For_Smart_Installation_Yes(driver).isDisplayed();{
		Log.info(sTestCaseName + " | Suitable For Smart Installation - Yes radio button displayed as expected");
		}
		
		Objects_Gas_Meter_Suitable_For_Smart_Installation_Page.btn_Suitable_For_Smart_Installation_No(driver).isDisplayed();{
		Log.info(sTestCaseName + " | Suitable For Smart Installation - No radio button displayed as expected");
		}
		
		Objects_Gas_Meter_Suitable_For_Smart_Installation_Page.txt_Additional_Notes(driver).isDisplayed();{
	...
	****************************************************************************************************/	
	...
	public static void viewSuitableYesPage(WebDriver driver, String sTestCaseName) throws Exception{
		...
		//Check that all of the elements of that are expected are displayed
		Objects_Gas_Meter_Suitable_For_Smart_Installation_Page.btn_Suitable_For_Smart_Installation_Yes(driver).click();{
		Log.info(sTestCaseName + " | Suitable For Smart Installation - Yes radio button clicked");
		}
		Objects_Gas_Meter_Suitable_For_Smart_Installation_Page.cbx_Equipment_Reposition_Required(driver).isDisplayed();{
	...
	****************************************************************************************************/	
	...
	public static void viewSuitableNoPage(WebDriver driver, String sTestCaseName) throws Exception{
		...
		//Check that all of the elements of that are expected are displayed
		Objects_Gas_Meter_Suitable_For_Smart_Installation_Page.btn_Suitable_For_Smart_Installation_No(driver).click();{
		Log.info(sTestCaseName + " | Risk Assessment - No radio button clicked");
		}
		Objects_Gas_Meter_Suitable_For_Smart_Installation_Page.btn_Suitable_For_Dumb_Instalation_Yes(driver).isDisplayed();{
		Log.info(sTestCaseName + " | Suitable for Dumb Installation - Yes radio button displayed as expected");
		}
		Objects_Gas_Meter_Suitable_For_Smart_Installation_Page.btn_Suitable_For_Dumb_Instalation_No(driver).isDisplayed();{
	...
	****************************************************************************************************/	
	...
	public static void addSuccessValues(WebDriver driver, String sTestCaseName) throws Exception{
		...
		Objects_Gas_Meter_Suitable_For_Smart_Installation_Page.cbx_Equipment_Reposition_Required(driver).click();
		Objects_Gas_Meter_Suitable_For_Smart_Installation_Page.cbx_Equipment_Reposition_Required(driver).sendKeys("NO");
	...
	****************************************************************************************************/	
	...
	public static void addAbortValues(WebDriver driver, String sTestCaseName) throws Exception{
		...
		Objects_Gas_Meter_Suitable_For_Smart_Installation_Page.btn_Suitable_For_Dumb_Instalation_No(driver).click();{
