/* *******************************************************************
* Test Case Name: Chrome_Cop2_Cop4_Test_Hv_Cp2
* Author: Charlotte Jones
* Date: 15/08/2018
* Purpose: This test carries out the C&I Mobility workflow in the
* 	Chrome browser for a COP2 COP4 test job where the metering
* 	supply type is HV CP2
*
**********************************************************************
* Change Log:
* 
...
public class Chrome_Cop2_Cop4_Test_Hv_Cp2 {
	...
	public void main() throws Exception {
		...
		CI_Methods_Ci_Pre_Task.addSuccessValuesCop2Hv(driver, sTestCaseName);
		...
		CI_Methods_Accuracy_Test_Cop4.addSuccessValuesCustLoadNonWc(driver, sTestCaseName);
