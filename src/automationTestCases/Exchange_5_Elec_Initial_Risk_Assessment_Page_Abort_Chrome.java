/* *******************************************************************
* Test Case Name: Exchange_5_Elec_Initial_Risk_Assessment_Abort_Chrome
* Author: Iain Storrie
* Date: 05/07/2017
...
public class Exchange_5_Elec_Initial_Risk_Assessment_Page_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 77);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 77);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 77);
		...
		Log.info("Test 77 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_5_Elec_Initial_Risk_Assessment_Page_Abort_Chrome");
