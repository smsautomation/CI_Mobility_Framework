...
public class Exchange_11_End_To_End_Spark_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_94_EXCH11')]")).click();
		...
		Log.info("Test 94 <<<<<<<< Paul Middleton >>>>>>>>Exchange_11_End_To_End_Spark_Chrome");
