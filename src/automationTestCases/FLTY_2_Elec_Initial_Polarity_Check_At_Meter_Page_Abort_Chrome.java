/* *******************************************************************
* Test Case Name: FLTY_2_Elec_Initial Polarity_Check_At_Meter_Abort_Chrome
* Author: Iain Storrie
* Date: 04/07/2017
...
* on the Chrome browser for a Faulty 2 job
*
**********************************************************************
* Change Log:
* 
...
public class FLTY_2_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[105]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_47_FLTY2')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 47);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 47);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 47);
		...
		//Verify that we are on the Electricity Meter Determine Emergency Call Out - Elec page
		...
		Log.info("Determine Emergency Call Out - Elec page displayed as expected");	
								
		//Verify Initial page elements displayed
		Methods_Electricity_Meter_Determine_Emergency_Call_Out_Elec.viewPage(driver, sTestCaseName);
		Log.info("Electricity Meter Determine Emergency Call Out Elec initial elements displayed as expected");
				
		//Invoke Method to complete a successful determination 
		Methods_Electricity_Meter_Determine_Emergency_Call_Out_Elec.addSuccessValues(driver, sTestCaseName);
		...
		Log.info("Test 47 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>FLTY_2_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_Chrome");
