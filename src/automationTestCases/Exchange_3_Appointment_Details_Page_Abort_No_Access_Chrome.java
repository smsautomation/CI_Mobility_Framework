...
public class Exchange_3_Appointment_Details_Page_Abort_No_Access_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_107_EXCH3')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 116);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 116);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 116);
		...
		Log.info("Test 107 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_3_Appointment_Details_Page_Abort_No_Access_Chrome");
