/* *******************************************************************
* Test Case Name: FLTY_2_Elec_Determine_Emergency_Call_Out_Abort_Chrome
* Author: Iain Storrie
* Date: 04/07/2017
* Purpose: This test ensure that a user can abort an appointment from the 
* Elec Determine Emergency Call Out - Elec page on the Chrome browser for 
* a Faulty 2 job
*
**********************************************************************
* Change Log:
...
public class FLTY_2_Elec_Determine_Emergency_Call_Out_Page_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[103]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_45_FLTY2')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 45);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 45);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 45);
		...
		//Invoke Method to complete an aborted determination 
		Methods_Electricity_Meter_Determine_Emergency_Call_Out_Elec.addAbortValues(driver, sTestCaseName);
		
		//Click Abort button to bring up Abort page 
		Objects_Electricity_Meter_Determine_Emergency_Call_Out_Elec_Page.btn_Abort(driver).click();
