...
public class Exchange_1_End_To_End_Spark_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_6_EXCH1')]")).click();
		...
		Log.info("Test 6 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_1_End_To_End_Spark_Chrome");
