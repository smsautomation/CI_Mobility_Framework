/* *******************************************************************
* Test Case Name: NMEX_5_End_To_End_Chrome
* Author: Iain Storrie
* Date: 30/06/2017
* Purpose: This test carries out the end to end Mobility workflow on 
* the Chrome browser for a Non-Meter Exchange 5 job
*
**********************************************************************
* Change Log:
* 
...
public class NMEX_5_End_To_End_Chrome {
	...
	public void main() throws Exception {
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 39);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 39);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 39);
