/* *******************************************************************
* Test Case Name: Exchange_11_Appointment_Details_Page_Abort_No_Access_Chrome
* Author: Iain Storrie
* Date: 07/07/2017
...
public class Exchange_11_Appointment_Details_Page_Abort_No_Access_Chrome {
	...
	public void main() throws Exception {
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 83);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 83);
		...
		Log.info("Test 83 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_11_Appointment_Details_Page_Abort_No_Access_Chrome");
	}
