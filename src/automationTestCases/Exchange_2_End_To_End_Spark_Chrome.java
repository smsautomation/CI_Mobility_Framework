/* *******************************************************************
* Test Case Name: Exchange_2_End_To_End_Chrome
* Author: Iain Storrie
* Date: 29/06/2017
* Purpose: This test carries out the end to end Mobility workflow on 
* the Chrome browser for an Exchange 2 job
*
**********************************************************************
* Change Log:
* 
...
public class Exchange_2_End_To_End_Spark_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[127]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_70_EXCH2')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 69);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 69);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 69);
		...
		Log.info("Electricity Meter Commissioning page displayed as expected");
		...
		Log.info("Electricity Meter Post Installation Checks page displayed as expected");
		...
		Log.info("Test 70 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_2_End_To_End_Spark_Chrome");
