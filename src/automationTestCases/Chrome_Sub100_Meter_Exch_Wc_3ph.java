/* *******************************************************************
* Test Case Name: Sub100_Meter_Exch_Wc_3ph
...
public class Chrome_Sub100_Meter_Exch_Wc_3ph {
	...
	public void main() throws Exception {
		...
		CI_Methods_Ci_Pre_Task.addSuccessValuesSub100Wc3ph(driver, sTestCaseName);
		...
		// Invoke method to complete the Meter Readings section
		...
		Log.info("Modem Comms Details (PSTN modem) section completed");
		...
		Log.info("Non-Serialised Asset Info (Elec install) section completed");
