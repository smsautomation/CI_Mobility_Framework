/* *******************************************************************
* Test Case Name: Exchange_3_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome
* Author: Iain Storrie
* Date: 14/06/2017
...
public class Exchange_3_Doorstep_Protocol_Page_Suspend_Doorstep_Procedure_Fail_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_110_EXCH3')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 110);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 110);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 110);
		...
		Methods_Doorstep_Protocol.addSuccessValuesSuspend(driver, sTestCaseName);
		
		//Click Abort No Access button to bring up Abort page 
		Objects_Doorstep_Protocol_Page.btn_Suspend_No_Access(driver).click();
		...
		Objects_Doorstep_Protocol_Page.btn_Suspend_Job_No(driver).click();{
		Log.info(sTestCaseName + " | Suspend Job - No button clicked");
		}
		
		Objects_Doorstep_Protocol_Page.btn_Reschedule_Appointment_Required_Yes(driver).click();{
		Log.info(sTestCaseName + " | Reschedule Appointment Required - Yes button clicked");
		}
		
		Objects_Doorstep_Protocol_Page.btn_Abort_No_Access(driver).click();
		Log.info(sTestCaseName + " | Abort No Access Button Clicked");	
		...
		Log.info("Test 110 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_3_Doorstep_Protocol_Page_Suspend_Doorstep_Procedure_Fail_Chrome");
