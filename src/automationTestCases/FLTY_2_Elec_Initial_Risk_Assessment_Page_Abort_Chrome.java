/* *******************************************************************
* Test Case Name: FLTY_2_Elec_Initial_Risk_Assessment_Abort_Chrome
* Author: Iain Storrie
* Date: 04/07/2017
...
public class FLTY_2_Elec_Initial_Risk_Assessment_Page_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[107]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_49_FLTY2')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 49);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 49);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 49);
		...
		Log.info("Test 49 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>FLTY_2_Elec_Initial_Risk_Assessment_Page_Abort_Chrome");
