/* *******************************************************************
* Test Case Name: Exchange_9_Appointment_Details_Page_Abort_No_Access_Chrome
* Author: Iain Storrie
* Date: 05/07/2017
...
public class Exchange_9_Appointment_Details_Page_Abort_No_Access_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[61]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_167_EXCH9')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 167);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 167);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 167);
		...
		Log.info("Test 167 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_9_Appointment_Details_Page_Abort_No_Access_Chrome");
