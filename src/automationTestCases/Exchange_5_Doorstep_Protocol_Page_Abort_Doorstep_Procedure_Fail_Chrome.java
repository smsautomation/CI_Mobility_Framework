/* *******************************************************************
* Test Case Name: Exchange_5_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome
* Author: Iain Storrie
* Date: 05/07/2017
...
public class Exchange_5_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[131]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_73_EXCH5')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 73);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 73);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 73);
		...
		Log.info("Test 73 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_5_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome");
	}
