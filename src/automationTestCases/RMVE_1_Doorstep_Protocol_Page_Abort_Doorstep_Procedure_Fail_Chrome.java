...
public class RMVE_1_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_21_RMVE1')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 21);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 21);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 21);
		...
		Log.info("Test 21 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>RMVE_1_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome");
