/* *******************************************************************
* Test Case Name: Exchange_2_Elec_Initial Polarity_Check_At_Meter_Abort_Chrome
* Author: Iain Storrie
* Date: 29/06/2017
...
public class Exchange_2_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_Chrome {
...
Methods_Login.viewPage(driver, sTestCaseName);
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 61);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 61);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 61);
		...
		Log.info("Test 61 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_2_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_Chrome");
	}
