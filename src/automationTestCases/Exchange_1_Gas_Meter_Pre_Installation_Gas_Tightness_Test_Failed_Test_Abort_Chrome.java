/* *******************************************************************
* Test Case Name: Exchange_1_Gas_Meter_Pre_Installation_Gas_Tightness_Test_Failed_Test_Abort_Chrome
* Author: Iain Storrie
* Date: 10/07/2017
...
* fails on the Chrome browser for an Exchange 1 job
*
**********************************************************************
* Change Log:
* 
...
public class Exchange_1_Gas_Meter_Pre_Installation_Gas_Tightness_Test_Failed_Test_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[175]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_11_EXCH1')]")).click();
		...
		Log.info("Test 11 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_1_Gas_Meter_Pre_Installation_Gas_Tightness_Test_Failed_Test_Abort_Chrome");
