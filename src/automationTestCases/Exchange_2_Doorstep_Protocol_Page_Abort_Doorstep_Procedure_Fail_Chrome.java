/* *******************************************************************
* Test Case Name: Exchange_2_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome
* Author: Iain Storrie
* Date: 29/06/2017
...
public class Exchange_2_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome {
...
Methods_Login.viewPage(driver, sTestCaseName);
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[115]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_57_EXCH2')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 57);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 57);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 57);
		...
		Log.info("Test 57 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_2_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome");
	}
