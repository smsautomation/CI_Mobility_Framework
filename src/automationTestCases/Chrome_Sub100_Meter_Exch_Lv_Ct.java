/* *******************************************************************
* Test Case Name: Chrome_Sub100_Meter_Exch_Lv_Ct
* Author: Charlotte Jones
* Date: 14/08/2018
* Purpose: This test carries out the C&I Mobility workflow in the
* 	Chrome browser for Sub100 meter exchange job, where the metering
...
public class Chrome_Sub100_Meter_Exch_Lv_Ct {
	...
	public void main() throws Exception {
		...
		CI_Methods_Ci_Pre_Task.addSuccessValuesSub100LvCt(driver, sTestCaseName);
		System.out.println("c&i pre task section completed");
		Thread.sleep(1500);
		System.err.println("end of where we can go");
		...
		Log.info("Modem Comms Details (Other modem) section completed");
