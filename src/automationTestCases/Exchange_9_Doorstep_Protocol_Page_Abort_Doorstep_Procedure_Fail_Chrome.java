/* *******************************************************************
* Test Case Name: Exchange_9_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome
* Author: Iain Storrie
* Date: 05/07/2017
...
public class Exchange_9_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[63]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_169_EXCH9')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 169);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 169);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 169);
		...
		Log.info("Test 169 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_9_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome");
