/* *******************************************************************
* Test Case Name: Exchange_9_Gas_Meter_Initial_Risk_Assessment_Gas_Abort_Chrome
* Author: Iain Storrie
* Date: 06/07/2017
...
public class Exchange_9_Gas_Meter_Initial_Risk_Assessment_Gas_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[77]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_183_EXCH9')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 183);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 183);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 183);
		...
		Methods_Gas_Meter_Initial_Risk_Assessment.addAbortValues(driver, sTestCaseName);		
		
		//Click Abort button to bring up Abort page 
		Objects_Gas_Meter_Initial_Risk_Assessment_Page.btn_Abort(driver).click();
		...
		Log.info("Test 183 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_9_Gas_Meter_Initial_Risk_Assessment_Gas_Abort_Chrome");
