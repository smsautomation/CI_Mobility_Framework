...
public class Exchange_5_Appointment_Details_Page_Abort_No_Access_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_71_EXCH5')]")).click();
		...
		Log.info("Test 71 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_5_Appointment_Details_Page_Abort_No_Access_Chrome");
