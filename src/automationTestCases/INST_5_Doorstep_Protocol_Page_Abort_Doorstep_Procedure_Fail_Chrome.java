/* *******************************************************************
* Test Case Name: INST_5_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome
* Author: Iain Storrie
* Date: 04/07/2017
...
public class INST_5_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[155]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_97_INST5')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 97);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 97);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 97);
		...
		Log.info("Test 97 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>INST_5_Doorstep_Protocol_Page_Abort_Doorstep_Procedure_Fail_Chrome");
