...
public class FLTY_17_Gas_Suitable_For_Smart_Installation_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_165_FLTY17')]")).click();
			...
			Log.info("Test 165 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>FLTY_17_Gas_Suitable_For_Smart_Installation_Abort_Chrome");
