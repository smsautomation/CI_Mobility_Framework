...
Methods_Login.viewPage(driver, sTestCaseName);
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[9]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_115_EXCH3')]")).click();
