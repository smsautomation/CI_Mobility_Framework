/* *******************************************************************
* Test Case Name: Exchange_5_Elec_Initial Polarity_Check_At_Meter_Abort_Chrome
* Author: Iain Storrie
* Date: 05/07/2017
...
* on the Chrome browser for an Exchange 5 job
*
**********************************************************************
* Change Log:
* 
...
public class Exchange_5_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[133]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_75_EXCH5')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 75);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 75);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 75);
		...
		Log.info("Test 75 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_5_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_Chrome");
