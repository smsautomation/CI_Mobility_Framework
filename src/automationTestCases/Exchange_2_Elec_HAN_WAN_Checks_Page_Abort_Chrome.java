...
public class Exchange_2_Elec_HAN_WAN_Checks_Page_Abort_Chrome {
...
Methods_Login.viewPage(driver, sTestCaseName);
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[117]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_59_EXCH2')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 59);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 59);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 59);
		...
		Log.info("Test 59 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_2_Elec_HAN_WAN_Checks_Page_Abort_Chrome");
	}
