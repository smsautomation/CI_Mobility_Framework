/* *******************************************************************
* Test Case Name: Exchange_3_Elec_Initial Polarity_Check_At_Meter_Abort_Chrome
* Author: Iain Storrie
* Date: 15/06/2017
...
public class Exchange_3_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[7]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_113_EXCH3')]")).click();
		...
		Log.info("Test 113 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_3_Elec_Initial_Polarity_Check_At_Meter_Page_Abort_Chrome");
