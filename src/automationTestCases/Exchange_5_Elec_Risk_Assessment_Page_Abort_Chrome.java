/* *******************************************************************
* Test Case Name: Exchange_5_Elec_Risk_Assessment_Elec_Abort_Chrome
* Author: Iain Storrie
* Date: 05/07/2017
...
* Chrome browser for an Exchange 5 job
*
**********************************************************************
* Change Log:
* 
...
public class Exchange_5_Elec_Risk_Assessment_Page_Abort_Chrome {
...
Methods_Login.viewPage(driver, sTestCaseName);
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[137]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_79_EXCH5')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 79);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 79);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 79);
		...
		Log.info("Test 79 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_5_Elec_Risk_Assessment_Page_Abort_Chrome");
