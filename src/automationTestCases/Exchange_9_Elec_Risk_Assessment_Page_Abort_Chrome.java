/* *******************************************************************
* Test Case Name: Exchange_9_Elec_Risk_Assessment_Elec_Abort_Chrome
* Author: Iain Storrie
* Date: 06/07/2017
...
* Chrome browser for an Exchange 9 job
*
**********************************************************************
* Change Log:
* 
...
public class Exchange_9_Elec_Risk_Assessment_Page_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[71]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_177_EXCH9')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 177);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 177);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 177);
		...
		Log.info("Test 177 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_9_Elec_Risk_Assessment_Page_Abort_Chrome");
