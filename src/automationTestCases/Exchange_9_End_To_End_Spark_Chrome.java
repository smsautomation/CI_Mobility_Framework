/* *******************************************************************
* Test Case Name: Exchange_9_End_To_End_Chrome
* Author: Iain Storrie
* Date: 06/07/2017
...
public class Exchange_9_End_To_End_Spark_Chrome {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_182_EXCH9')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 181);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 181);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 181);
		...
		//Verify that we are on the Job Completion Smart Education page
		Objects_Job_Completion_Smart_Education_Page.lbl_Smart_Education(driver).isDisplayed();
		Log.info("Job Completion Smart Education page displayed as expected");
			
		//Verify Initial page elements displayed
		Methods_Job_Completion_Smart_Education.viewPage(driver, sTestCaseName);
		Log.info("Job Completion Smart Education initial elements displayed as expected");
																																				
		//Invoke Method to complete Smart Education page 
		...
		Log.info("Test 182 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_9_End_To_End_Spark_Chrome");
