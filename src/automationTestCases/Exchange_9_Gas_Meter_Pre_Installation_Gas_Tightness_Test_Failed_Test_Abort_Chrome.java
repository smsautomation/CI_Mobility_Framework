/* *******************************************************************
* Test Case Name: Exchange_9_Gas_Meter_Pre_Installation_Gas_Tightness_Test_Failed_Test_Abort_Chrome
* Author: Iain Storrie
* Date: 06/07/2017
* Purpose: This test ensure that a user can abort an appointment from the 
* Gas Meter Pre Installation Gas Tightness Test page where the gas tightness test
* fails on the Chrome browser for an Exchange 9 job
*
**********************************************************************
* Change Log:
* 
...
public class Exchange_9_Gas_Meter_Pre_Installation_Gas_Tightness_Test_Failed_Test_Abort_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[81]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_187_EXCH9')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 187);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 187);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 187);
		...
		Methods_Gas_Meter_Pre_Installation_Gas_Tightness_Test.addAbortValuesFailedTest(driver, sTestCaseName);
		...
		Log.info("Test 187 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>Exchange_9_Gas_Meter_Pre_Installation_Gas_Tightness_Test_Failed_Test_Abort_Chrome");
