/* *******************************************************************
* Test Case Name: Chrome_Cop5_Check_Meter_Removal_Wc_3ph_Cp5
* Author: Charlotte Jones
* Date: 15/08/2018
* Purpose: This test carries out the C&I Mobility workflow in the
* 	Chrome browser for a COP5 check meter removal job where the metering
* 	supply type is WC 3PH CP5
*
**********************************************************************
* Change Log:
* 
...
public class Chrome_Cop5_Check_Meter_Removal_Wc_3ph_Cp5 {
	...
	public void main() throws Exception {
		...
		CI_Methods_Ci_Pre_Task.addSuccessValuesCop5Wc3ph(driver, sTestCaseName);
		...
		// Invoke method to complete the Detailed Meter Readings section - for the existing meter
		
		
		// Invoke method to complete Detailed Meter Readings section - for the check meter to be removed
		...
		// Invoke method to complete the Polarity Check - Martindale section
		CI_Methods_Polarity_Check_Martindale.addSuccessValuesAll(driver, sTestCaseName);
		
		// Invoke method to complete the Check Meter Removal section
		CI_Methods_Check_Meter_Removal.addSuccessValuesAll(driver, sTestCaseName);
