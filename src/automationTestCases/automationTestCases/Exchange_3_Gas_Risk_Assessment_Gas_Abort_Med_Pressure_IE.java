/* *******************************************************************
* Test Case Name: Exchange_3_Gas_Risk_Assessment_Gas_Abort_Med_Pressure_IE
* Author: Iain Storrie
* Date: 19/06/2017
...
public class Exchange_3_Gas_Risk_Assessment_Gas_Abort_Med_Pressure_IE {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[26]/div/div[1]/div/div[1]/span[1]/span")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 132);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 132);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 132);
