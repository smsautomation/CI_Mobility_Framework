...
public class Exchange_5_End_To_End_IE {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[140]/div/div[1]/div/div[1]/span[1]/span")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 82);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 82);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 82);
