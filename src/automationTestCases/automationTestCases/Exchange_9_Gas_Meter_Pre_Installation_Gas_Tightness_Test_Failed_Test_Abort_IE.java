/* *******************************************************************
* Test Case Name: Exchange_9_Gas_Meter_Pre_Installation_Gas_Tightness_Test_Failed_Test_Abort_IE
* Author: Iain Storrie
* Date: 06/07/2017
...
* fails on the IE browser for an Exchange 9 job
*
**********************************************************************
* Change Log:
* 
...
public class Exchange_9_Gas_Meter_Pre_Installation_Gas_Tightness_Test_Failed_Test_Abort_IE {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[82]/div/div[1]/div/div[1]/span[1]/span")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 188);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 188);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 188);
