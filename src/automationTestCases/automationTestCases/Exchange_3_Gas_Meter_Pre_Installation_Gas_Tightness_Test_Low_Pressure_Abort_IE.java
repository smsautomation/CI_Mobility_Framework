...
public class Exchange_3_Gas_Meter_Pre_Installation_Gas_Tightness_Test_Low_Pressure_Abort_IE {
	...
	public void main() throws Exception {
		...
		driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[22]/div/div[1]/div/div[1]/span[1]/span")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 128);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 128);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 128);
