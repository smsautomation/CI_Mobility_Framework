/* *******************************************************************
* Test Case Name: FLTY_17_Gas_Risk_Assessment_Gas_Abort_Med_Pressure_Chrome
* Author: Iain Storrie
* Date: 03/07/2017
...
* pressure on the Chrome browser for a Faulty 17 job
*
**********************************************************************
* Change Log:
* 
...
public class FLTY_17_Gas_Risk_Assessment_Gas_Abort_Med_Pressure_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[57]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_163_FLTY17')]")).click();
		...
		Log.info("Test 163 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>FLTY_17_Gas_Risk_Assessment_Gas_Abort_Med_Pressure_Chrome");
