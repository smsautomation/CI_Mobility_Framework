/* *******************************************************************
* Test Case Name: RMVE_1_Gas_Risk_Assessment_Gas_Abort_Low_Pressure_Chrome
* Author: Iain Storrie
* Date: 10/07/2017
...
public class RMVE_1_Gas_Risk_Assessment_Gas_Abort_Low_Pressure_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[191]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_27_RMVE1')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 27);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 27);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 27);
		...
		Log.info("Test 27 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>RMVE_1_Gas_Risk_Assessment_Gas_Abort_Low_Pressure_Chrome");
