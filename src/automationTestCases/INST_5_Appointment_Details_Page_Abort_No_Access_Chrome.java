/* *******************************************************************
* Test Case Name: INST_5_Appointment_Details_Page_Abort_No_Access_Chrome
* Author: Iain Storrie
* Date: 04/07/2017
...
public class INST_5_Appointment_Details_Page_Abort_No_Access_Chrome {
	...
	public void main() throws Exception {
		...
		//driver.findElement(By.xpath(".//*[@id='app']/div/div/workorderlistitem[153]/div/div[1]/div/div[1]/span[1]/span")).click();
		driver.findElement(By.xpath("//*[contains(text(), ' MR. Test_95_INST5')]")).click();
		...
		Methods_Appointment_Details.viewCustomerDetails(driver, sTestCaseName, 95);
				
		//Verify correct Job Details displayed
		Objects_Appointment_Details_Page.lnk_Job_Details(driver).click();
		Methods_Appointment_Details.viewJobDetails(driver, sTestCaseName, 95);
				
		//Verify correct Meter Details displayed
		Objects_Appointment_Details_Page.lnk_Meter_Details(driver).click();
		Methods_Appointment_Details.viewMeterDetails(driver, sTestCaseName, 95);
		...
		Log.info("Test 95 <<<<<<<<<<Completed By Paul Middleton>>>>>>>>>>INST_5_Appointment_Details_Page_Abort_No_Access_Chrome");
